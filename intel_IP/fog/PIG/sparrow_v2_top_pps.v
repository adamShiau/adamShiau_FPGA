...
//  assign DAC1 = pps_trig_out<<15 - 1'b1;
...
wire pps_trig_out;
// wire [31:0] o_pulse_number, o_half_period_cnt;
// wire [3:0] o_pps_cstate, o_pps_nstate;
...
PPS_Sync_v3 
#(.PULSE_NUM(100),  // for 100 Hz datarate
.HALF_PERIOD(500000) //1e6*10ns = 10ms, pulse dt
) 
pps_inst
(
.i_clk(DAC_CLK),
...
.o_pulse_number(), //[31:0] 
.o_half_period_cnt(), //[31:0] 
.o_cstate(),  //[3:0] 
.o_nstate() //[3:0] 
);

//assign fifo_we = fifo_full? 1'b0 : 1'b1;
//assign fifo_re = fifo_empty? 1'b0 : 1'b1;


//	myBufwFIR myBufwFIR_inst
//(
//	.data(ADC_D1),
//	.rdclk(DAC_CLK),
//	.rdreq(fifo_re),
...
//	.rdempty(fifo_empty),
//	.wrfull(fifo_full),
//	.monitor_fifout(fifo_adc)
//
//);
//
//always@(posedge DAC_CLK) begin
//	r_adc <= {{14{fir_adc[18-1]}}, fir_adc};
//end
...
//	.trigger_in_export (pps_trig_out) //pps MODE
	.trigger_in_export (TRIG_IN) 
 );
 
// reg [31:0] trig_cnt = 32'd1000000, trig_num = 32'd5;
// reg pps_trig;
// 
...
//    end
//	else begin
//		if(trig_cnt != 32'd1) begin
//			pps_trig <= 0;
//			trig_num <= trig_num - 1'b1;
//		end
//		else begin
//			 trig_cnt <= 32'd1000000;
//			 pps_trig <= 1;
//		end
//	end
//end
