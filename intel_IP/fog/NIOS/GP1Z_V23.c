...
#define FPGA_VERSION "FPGA-GP-PLL100-23"
...
//			***/
//			sprintf(heading_angle, "%6.2f", t_cnt);
//			send_uart_string(heading_angle);
////			printf("%s", heading_angle);
//			t_cnt += 0.01;
//			usleep(100000);
//			t_cnt = 0;
			heading_angle = 0;
			...
			f_step.float_val = (float)step*SF_A;
			checkByte(171); //AB
			checkByte(186); //BA
...
//				sprintf(heading_angle_str, "%6.3f", f_step.float_val);
