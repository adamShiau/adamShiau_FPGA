...
#define FPGA_VERSION "FPGA-GP-PLL100-31"
...
#define O_VAR_DITHER_H  	16
#define O_VAR_DITHER_L  	17
#define O_VAR_DITHER_PERIOD 18
#define O_VAR_DITHER_AVG  	19
/***R***/
...
void FOG_init()
{
	...
	IOWR(VARSET_BASE, O_VAR_OFFSET, 5);
//	IOWR(VARSET_BASE, O_VAR_POLARITY, 1);
	Set_FB_Polarity(0);
	Set_CloseLoop_mode();
//	IOWR(VARSET_BASE, O_VAR_FB_ON, 0);
	IOWR(VARSET_BASE, O_VAR_WAITCNT, 20);
	IOWR(VARSET_BASE, O_VAR_ERRTH, -10);
...
//	IOWR(VARSET_BASE, O_VAR_FB_ON, 1); //0: OPEN loop
	...
	IOWR(VARSET_BASE, O_VAR_TIMER_RST, 0);
	IOWR(VARSET_BASE, O_VAR_KAL_Q, 190);
	IOWR(VARSET_BASE, O_VAR_KAL_R, 10);
	IOWR(VARSET_BASE, O_VAR_DITHER_H, 0);
	IOWR(VARSET_BASE, O_VAR_DITHER_L, 0);
	IOWR(VARSET_BASE, O_VAR_DITHER_PERIOD, 100);
	IOWR(VARSET_BASE, O_VAR_DITHER_AVG, 10);
