...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../LGSM_PRJ_V1.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2002280
SOPC_SYSID_FLAG += --sidp=0x2002280
ELF_PATCH_FLAG  += --sidp 0x2002280

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1773503584
SOPC_SYSID_FLAG += --timestamp=1773503584
ELF_PATCH_FLAG  += --timestamp 1773503584
