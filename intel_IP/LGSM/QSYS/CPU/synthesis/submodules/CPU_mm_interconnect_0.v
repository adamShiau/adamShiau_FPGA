...
module CPU_mm_interconnect_0 (
		...
		output wire [2:0]  spi_ADDA_spi_control_port_address,           //             spi_ADDA_spi_control_port.address
		output wire        spi_ADDA_spi_control_port_write,             //                                      .write
		output wire        spi_ADDA_spi_control_port_read,              //                                      .read
		input  wire [15:0] spi_ADDA_spi_control_port_readdata,          //                                      .readdata
		output wire [15:0] spi_ADDA_spi_control_port_writedata,         //                                      .writedata
		output wire        spi_ADDA_spi_control_port_chipselect,        //                                      .chipselect
		output wire [1:0]  sync_in_s1_address,                          //                            sync_in_s1.address
		output wire        sync_in_s1_write,                            //                                      .write
		input  wire [31:0] sync_in_s1_readdata,                         //                                      .readdata
		output wire [31:0] sync_in_s1_writedata,                        //                                      .writedata
		output wire        sync_in_s1_chipselect,                       //                                      .chipselect
	...
	wire   [12:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> VarSet_1_avalon_slave_agent:cp_channel
	...
	wire   [12:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> nios2_debug_mem_slave_agent:cp_channel
	...
	wire   [12:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> epcs_epcs_control_port_agent:cp_channel
	...
	wire  [103:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> uart_s1_agent:cp_data
	...
	wire   [25:0] i2c_scl_s1_agent_m0_address;                                                 // I2C_SCL_s1_agent:m0_address -> I2C_SCL_s1_translator:uav_address
	...
	wire  [104:0] i2c_scl_s1_agent_rf_source_data;                                             // I2C_SCL_s1_agent:rf_source_data -> I2C_SCL_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] i2c_scl_s1_agent_rsp_fifo_out_data;                                          // I2C_SCL_s1_agent_rsp_fifo:out_data -> I2C_SCL_s1_agent:rf_sink_data
	...
	wire          cmd_mux_007_src_valid;                                                       // cmd_mux_007:src_valid -> I2C_SCL_s1_agent:cp_valid
	wire  [103:0] cmd_mux_007_src_data;                                                        // cmd_mux_007:src_data -> I2C_SCL_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                       // I2C_SCL_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [12:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> I2C_SCL_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                               // cmd_mux_007:src_startofpacket -> I2C_SCL_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                 // cmd_mux_007:src_endofpacket -> I2C_SCL_s1_agent:cp_endofpacket
	...
	wire   [25:0] i2c_sda_s1_agent_m0_address;                                                 // I2C_SDA_s1_agent:m0_address -> I2C_SDA_s1_translator:uav_address
	...
	wire  [104:0] i2c_sda_s1_agent_rf_source_data;                                             // I2C_SDA_s1_agent:rf_source_data -> I2C_SDA_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] i2c_sda_s1_agent_rsp_fifo_out_data;                                          // I2C_SDA_s1_agent_rsp_fifo:out_data -> I2C_SDA_s1_agent:rf_sink_data
	...
	wire          cmd_mux_008_src_valid;                                                       // cmd_mux_008:src_valid -> I2C_SDA_s1_agent:cp_valid
	wire  [103:0] cmd_mux_008_src_data;                                                        // cmd_mux_008:src_data -> I2C_SDA_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                       // I2C_SDA_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [12:0] cmd_mux_008_src_channel;                                                     // cmd_mux_008:src_channel -> I2C_SDA_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                               // cmd_mux_008:src_startofpacket -> I2C_SDA_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                 // cmd_mux_008:src_endofpacket -> I2C_SDA_s1_agent:cp_endofpacket
	wire   [31:0] sync_in_s1_agent_m0_readdata;                                                // sync_in_s1_translator:uav_readdata -> sync_in_s1_agent:m0_readdata
	wire          sync_in_s1_agent_m0_waitrequest;                                             // sync_in_s1_translator:uav_waitrequest -> sync_in_s1_agent:m0_waitrequest
	wire          sync_in_s1_agent_m0_debugaccess;                                             // sync_in_s1_agent:m0_debugaccess -> sync_in_s1_translator:uav_debugaccess
	wire   [25:0] sync_in_s1_agent_m0_address;                                                 // sync_in_s1_agent:m0_address -> sync_in_s1_translator:uav_address
	wire    [3:0] sync_in_s1_agent_m0_byteenable;                                              // sync_in_s1_agent:m0_byteenable -> sync_in_s1_translator:uav_byteenable
	wire          sync_in_s1_agent_m0_read;                                                    // sync_in_s1_agent:m0_read -> sync_in_s1_translator:uav_read
	wire          sync_in_s1_agent_m0_readdatavalid;                                           // sync_in_s1_translator:uav_readdatavalid -> sync_in_s1_agent:m0_readdatavalid
	wire          sync_in_s1_agent_m0_lock;                                                    // sync_in_s1_agent:m0_lock -> sync_in_s1_translator:uav_lock
	wire   [31:0] sync_in_s1_agent_m0_writedata;                                               // sync_in_s1_agent:m0_writedata -> sync_in_s1_translator:uav_writedata
	wire          sync_in_s1_agent_m0_write;                                                   // sync_in_s1_agent:m0_write -> sync_in_s1_translator:uav_write
	wire    [2:0] sync_in_s1_agent_m0_burstcount;                                              // sync_in_s1_agent:m0_burstcount -> sync_in_s1_translator:uav_burstcount
	wire          sync_in_s1_agent_rf_source_valid;                                            // sync_in_s1_agent:rf_source_valid -> sync_in_s1_agent_rsp_fifo:in_valid
	wire  [104:0] sync_in_s1_agent_rf_source_data;                                             // sync_in_s1_agent:rf_source_data -> sync_in_s1_agent_rsp_fifo:in_data
	wire          sync_in_s1_agent_rf_source_ready;                                            // sync_in_s1_agent_rsp_fifo:in_ready -> sync_in_s1_agent:rf_source_ready
	wire          sync_in_s1_agent_rf_source_startofpacket;                                    // sync_in_s1_agent:rf_source_startofpacket -> sync_in_s1_agent_rsp_fifo:in_startofpacket
	wire          sync_in_s1_agent_rf_source_endofpacket;                                      // sync_in_s1_agent:rf_source_endofpacket -> sync_in_s1_agent_rsp_fifo:in_endofpacket
	wire          sync_in_s1_agent_rsp_fifo_out_valid;                                         // sync_in_s1_agent_rsp_fifo:out_valid -> sync_in_s1_agent:rf_sink_valid
	wire  [104:0] sync_in_s1_agent_rsp_fifo_out_data;                                          // sync_in_s1_agent_rsp_fifo:out_data -> sync_in_s1_agent:rf_sink_data
	wire          sync_in_s1_agent_rsp_fifo_out_ready;                                         // sync_in_s1_agent:rf_sink_ready -> sync_in_s1_agent_rsp_fifo:out_ready
	wire          sync_in_s1_agent_rsp_fifo_out_startofpacket;                                 // sync_in_s1_agent_rsp_fifo:out_startofpacket -> sync_in_s1_agent:rf_sink_startofpacket
	wire          sync_in_s1_agent_rsp_fifo_out_endofpacket;                                   // sync_in_s1_agent_rsp_fifo:out_endofpacket -> sync_in_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_009_src_valid;                                                       // cmd_mux_009:src_valid -> sync_in_s1_agent:cp_valid
	wire  [103:0] cmd_mux_009_src_data;                                                        // cmd_mux_009:src_data -> sync_in_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                       // sync_in_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [12:0] cmd_mux_009_src_channel;                                                     // cmd_mux_009:src_channel -> sync_in_s1_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                               // cmd_mux_009:src_startofpacket -> sync_in_s1_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                 // cmd_mux_009:src_endofpacket -> sync_in_s1_agent:cp_endofpacket
	...
	wire   [12:0] cmd_mux_010_src_channel;                                                     // cmd_mux_010:src_channel -> DAC_RST_s1_agent:cp_channel
	...
	wire          cmd_mux_011_src_valid;                                                       // cmd_mux_011:src_valid -> uart_dbg_s1_agent:cp_valid
	wire  [103:0] cmd_mux_011_src_data;                                                        // cmd_mux_011:src_data -> uart_dbg_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                       // uart_dbg_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [12:0] cmd_mux_011_src_channel;                                                     // cmd_mux_011:src_channel -> uart_dbg_s1_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                               // cmd_mux_011:src_startofpacket -> uart_dbg_s1_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                                 // cmd_mux_011:src_endofpacket -> uart_dbg_s1_agent:cp_endofpacket
	wire   [31:0] spi_adda_spi_control_port_agent_m0_readdata;                                 // spi_ADDA_spi_control_port_translator:uav_readdata -> spi_ADDA_spi_control_port_agent:m0_readdata
	wire          spi_adda_spi_control_port_agent_m0_waitrequest;                              // spi_ADDA_spi_control_port_translator:uav_waitrequest -> spi_ADDA_spi_control_port_agent:m0_waitrequest
	wire          spi_adda_spi_control_port_agent_m0_debugaccess;                              // spi_ADDA_spi_control_port_agent:m0_debugaccess -> spi_ADDA_spi_control_port_translator:uav_debugaccess
	wire   [25:0] spi_adda_spi_control_port_agent_m0_address;                                  // spi_ADDA_spi_control_port_agent:m0_address -> spi_ADDA_spi_control_port_translator:uav_address
	wire    [3:0] spi_adda_spi_control_port_agent_m0_byteenable;                               // spi_ADDA_spi_control_port_agent:m0_byteenable -> spi_ADDA_spi_control_port_translator:uav_byteenable
	wire          spi_adda_spi_control_port_agent_m0_read;                                     // spi_ADDA_spi_control_port_agent:m0_read -> spi_ADDA_spi_control_port_translator:uav_read
	wire          spi_adda_spi_control_port_agent_m0_readdatavalid;                            // spi_ADDA_spi_control_port_translator:uav_readdatavalid -> spi_ADDA_spi_control_port_agent:m0_readdatavalid
	wire          spi_adda_spi_control_port_agent_m0_lock;                                     // spi_ADDA_spi_control_port_agent:m0_lock -> spi_ADDA_spi_control_port_translator:uav_lock
	wire   [31:0] spi_adda_spi_control_port_agent_m0_writedata;                                // spi_ADDA_spi_control_port_agent:m0_writedata -> spi_ADDA_spi_control_port_translator:uav_writedata
	wire          spi_adda_spi_control_port_agent_m0_write;                                    // spi_ADDA_spi_control_port_agent:m0_write -> spi_ADDA_spi_control_port_translator:uav_write
	wire    [2:0] spi_adda_spi_control_port_agent_m0_burstcount;                               // spi_ADDA_spi_control_port_agent:m0_burstcount -> spi_ADDA_spi_control_port_translator:uav_burstcount
	wire          spi_adda_spi_control_port_agent_rf_source_valid;                             // spi_ADDA_spi_control_port_agent:rf_source_valid -> spi_ADDA_spi_control_port_agent_rsp_fifo:in_valid
	wire  [104:0] spi_adda_spi_control_port_agent_rf_source_data;                              // spi_ADDA_spi_control_port_agent:rf_source_data -> spi_ADDA_spi_control_port_agent_rsp_fifo:in_data
	wire          spi_adda_spi_control_port_agent_rf_source_ready;                             // spi_ADDA_spi_control_port_agent_rsp_fifo:in_ready -> spi_ADDA_spi_control_port_agent:rf_source_ready
	wire          spi_adda_spi_control_port_agent_rf_source_startofpacket;                     // spi_ADDA_spi_control_port_agent:rf_source_startofpacket -> spi_ADDA_spi_control_port_agent_rsp_fifo:in_startofpacket
	wire          spi_adda_spi_control_port_agent_rf_source_endofpacket;                       // spi_ADDA_spi_control_port_agent:rf_source_endofpacket -> spi_ADDA_spi_control_port_agent_rsp_fifo:in_endofpacket
	wire          spi_adda_spi_control_port_agent_rsp_fifo_out_valid;                          // spi_ADDA_spi_control_port_agent_rsp_fifo:out_valid -> spi_ADDA_spi_control_port_agent:rf_sink_valid
	wire  [104:0] spi_adda_spi_control_port_agent_rsp_fifo_out_data;                           // spi_ADDA_spi_control_port_agent_rsp_fifo:out_data -> spi_ADDA_spi_control_port_agent:rf_sink_data
	wire          spi_adda_spi_control_port_agent_rsp_fifo_out_ready;                          // spi_ADDA_spi_control_port_agent:rf_sink_ready -> spi_ADDA_spi_control_port_agent_rsp_fifo:out_ready
	wire          spi_adda_spi_control_port_agent_rsp_fifo_out_startofpacket;                  // spi_ADDA_spi_control_port_agent_rsp_fifo:out_startofpacket -> spi_ADDA_spi_control_port_agent:rf_sink_startofpacket
	wire          spi_adda_spi_control_port_agent_rsp_fifo_out_endofpacket;                    // spi_ADDA_spi_control_port_agent_rsp_fifo:out_endofpacket -> spi_ADDA_spi_control_port_agent:rf_sink_endofpacket
	wire          cmd_mux_012_src_valid;                                                       // cmd_mux_012:src_valid -> spi_ADDA_spi_control_port_agent:cp_valid
	wire  [103:0] cmd_mux_012_src_data;                                                        // cmd_mux_012:src_data -> spi_ADDA_spi_control_port_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                       // spi_ADDA_spi_control_port_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [12:0] cmd_mux_012_src_channel;                                                     // cmd_mux_012:src_channel -> spi_ADDA_spi_control_port_agent:cp_channel
	wire          cmd_mux_012_src_startofpacket;                                               // cmd_mux_012:src_startofpacket -> spi_ADDA_spi_control_port_agent:cp_startofpacket
	wire          cmd_mux_012_src_endofpacket;                                                 // cmd_mux_012:src_endofpacket -> spi_ADDA_spi_control_port_agent:cp_endofpacket
	...
	wire  [103:0] uart_s1_agent_rp_data;                                                       // uart_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [103:0] i2c_scl_s1_agent_rp_data;                                                    // I2C_SCL_s1_agent:rp_data -> router_009:sink_data
	...
	wire          i2c_sda_s1_agent_rp_valid;                                                   // I2C_SDA_s1_agent:rp_valid -> router_010:sink_valid
	wire  [103:0] i2c_sda_s1_agent_rp_data;                                                    // I2C_SDA_s1_agent:rp_data -> router_010:sink_data
	wire          i2c_sda_s1_agent_rp_ready;                                                   // router_010:sink_ready -> I2C_SDA_s1_agent:rp_ready
	wire          i2c_sda_s1_agent_rp_startofpacket;                                           // I2C_SDA_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          i2c_sda_s1_agent_rp_endofpacket;                                             // I2C_SDA_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          sync_in_s1_agent_rp_valid;                                                   // sync_in_s1_agent:rp_valid -> router_011:sink_valid
	wire  [103:0] sync_in_s1_agent_rp_data;                                                    // sync_in_s1_agent:rp_data -> router_011:sink_data
	wire          sync_in_s1_agent_rp_ready;                                                   // router_011:sink_ready -> sync_in_s1_agent:rp_ready
	wire          sync_in_s1_agent_rp_startofpacket;                                           // sync_in_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          sync_in_s1_agent_rp_endofpacket;                                             // sync_in_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire          uart_dbg_s1_agent_rp_valid;                                                  // uart_dbg_s1_agent:rp_valid -> router_013:sink_valid
	wire  [103:0] uart_dbg_s1_agent_rp_data;                                                   // uart_dbg_s1_agent:rp_data -> router_013:sink_data
	wire          uart_dbg_s1_agent_rp_ready;                                                  // router_013:sink_ready -> uart_dbg_s1_agent:rp_ready
	wire          uart_dbg_s1_agent_rp_startofpacket;                                          // uart_dbg_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          uart_dbg_s1_agent_rp_endofpacket;                                            // uart_dbg_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire          spi_adda_spi_control_port_agent_rp_valid;                                    // spi_ADDA_spi_control_port_agent:rp_valid -> router_014:sink_valid
	wire  [103:0] spi_adda_spi_control_port_agent_rp_data;                                     // spi_ADDA_spi_control_port_agent:rp_data -> router_014:sink_data
	wire          spi_adda_spi_control_port_agent_rp_ready;                                    // router_014:sink_ready -> spi_ADDA_spi_control_port_agent:rp_ready
	wire          spi_adda_spi_control_port_agent_rp_startofpacket;                            // spi_ADDA_spi_control_port_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          spi_adda_spi_control_port_agent_rp_endofpacket;                              // spi_ADDA_spi_control_port_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire          i2c_scl_s1_agent_rdata_fifo_src_valid;                                       // I2C_SCL_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] i2c_scl_s1_agent_rdata_fifo_src_data;                                        // I2C_SCL_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          i2c_scl_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_007:in_0_ready -> I2C_SCL_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                           // avalon_st_adapter_007:out_0_valid -> I2C_SCL_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                            // avalon_st_adapter_007:out_0_data -> I2C_SCL_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                           // I2C_SCL_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                           // avalon_st_adapter_007:out_0_error -> I2C_SCL_s1_agent:rdata_fifo_sink_error
	wire          i2c_sda_s1_agent_rdata_fifo_src_valid;                                       // I2C_SDA_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] i2c_sda_s1_agent_rdata_fifo_src_data;                                        // I2C_SDA_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          i2c_sda_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_008:in_0_ready -> I2C_SDA_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                           // avalon_st_adapter_008:out_0_valid -> I2C_SDA_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                            // avalon_st_adapter_008:out_0_data -> I2C_SDA_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                           // I2C_SDA_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                           // avalon_st_adapter_008:out_0_error -> I2C_SDA_s1_agent:rdata_fifo_sink_error
	wire          sync_in_s1_agent_rdata_fifo_src_valid;                                       // sync_in_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] sync_in_s1_agent_rdata_fifo_src_data;                                        // sync_in_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          sync_in_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_009:in_0_ready -> sync_in_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_009_out_0_valid;                                           // avalon_st_adapter_009:out_0_valid -> sync_in_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                            // avalon_st_adapter_009:out_0_data -> sync_in_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                           // sync_in_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                           // avalon_st_adapter_009:out_0_error -> sync_in_s1_agent:rdata_fifo_sink_error
	...
	wire          uart_dbg_s1_agent_rdata_fifo_src_valid;                                      // uart_dbg_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] uart_dbg_s1_agent_rdata_fifo_src_data;                                       // uart_dbg_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          uart_dbg_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_011:in_0_ready -> uart_dbg_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                           // avalon_st_adapter_011:out_0_valid -> uart_dbg_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                            // avalon_st_adapter_011:out_0_data -> uart_dbg_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                           // uart_dbg_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                           // avalon_st_adapter_011:out_0_error -> uart_dbg_s1_agent:rdata_fifo_sink_error
	wire          spi_adda_spi_control_port_agent_rdata_fifo_src_valid;                        // spi_ADDA_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire   [33:0] spi_adda_spi_control_port_agent_rdata_fifo_src_data;                         // spi_ADDA_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire          spi_adda_spi_control_port_agent_rdata_fifo_src_ready;                        // avalon_st_adapter_012:in_0_ready -> spi_ADDA_spi_control_port_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_012_out_0_valid;                                           // avalon_st_adapter_012:out_0_valid -> spi_ADDA_spi_control_port_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_012_out_0_data;                                            // avalon_st_adapter_012:out_0_data -> spi_ADDA_spi_control_port_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_012_out_0_ready;                                           // spi_ADDA_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire    [0:0] avalon_st_adapter_012_out_0_error;                                           // avalon_st_adapter_012:out_0_error -> spi_ADDA_spi_control_port_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sync_in_s1_translator (
		.clk                    (clk_CPU_clk_clk),                             //                      clk.clk
		.reset                  (jtag_uart_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sync_in_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (sync_in_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (sync_in_s1_agent_m0_read),                    //                         .read
		.uav_write              (sync_in_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (sync_in_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (sync_in_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (sync_in_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (sync_in_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (sync_in_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (sync_in_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (sync_in_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (sync_in_s1_address),                          //      avalon_anti_slave_0.address
		.av_write               (sync_in_s1_write),                            //                         .write
		.av_readdata            (sync_in_s1_readdata),                         //                         .readdata
		.av_writedata           (sync_in_s1_writedata),                        //                         .writedata
		.av_chipselect          (sync_in_s1_chipselect),                       //                         .chipselect
		.av_read                (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
		.av_beginbursttransfer  (),                                            //              (terminated)
		.av_burstcount          (),                                            //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) spi_adda_spi_control_port_translator (
		.clk                    (clk_CPU_clk_clk),                                  //                      clk.clk
		.reset                  (jtag_uart_reset_reset_bridge_in_reset_reset),      //                    reset.reset
		.uav_address            (spi_adda_spi_control_port_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (spi_adda_spi_control_port_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (spi_adda_spi_control_port_agent_m0_read),          //                         .read
		.uav_write              (spi_adda_spi_control_port_agent_m0_write),         //                         .write
		.uav_waitrequest        (spi_adda_spi_control_port_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (spi_adda_spi_control_port_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (spi_adda_spi_control_port_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (spi_adda_spi_control_port_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (spi_adda_spi_control_port_agent_m0_writedata),     //                         .writedata
		.uav_lock               (spi_adda_spi_control_port_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (spi_adda_spi_control_port_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (spi_ADDA_spi_control_port_address),                //      avalon_anti_slave_0.address
		.av_write               (spi_ADDA_spi_control_port_write),                  //                         .write
		.av_read                (spi_ADDA_spi_control_port_read),                   //                         .read
		.av_readdata            (spi_ADDA_spi_control_port_readdata),               //                         .readdata
		.av_writedata           (spi_ADDA_spi_control_port_writedata),              //                         .writedata
		.av_chipselect          (spi_ADDA_spi_control_port_chipselect),             //                         .chipselect
		.av_begintransfer       (),                                                 //              (terminated)
		.av_beginbursttransfer  (),                                                 //              (terminated)
		.av_burstcount          (),                                                 //              (terminated)
		.av_byteenable          (),                                                 //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_CPU_clk_clk),                             //             clk.clk
		.reset                   (jtag_uart_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (sync_in_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (sync_in_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (sync_in_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (sync_in_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (sync_in_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (sync_in_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (sync_in_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (sync_in_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (sync_in_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (sync_in_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (sync_in_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (sync_in_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (sync_in_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (sync_in_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (sync_in_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (sync_in_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (sync_in_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (sync_in_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (sync_in_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (sync_in_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (sync_in_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (sync_in_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (sync_in_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (sync_in_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (sync_in_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (sync_in_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_009_out_0_ready),           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_009_out_0_valid),           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_009_out_0_data),            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_009_out_0_error),           //                .error
		.rdata_fifo_src_ready    (sync_in_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sync_in_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (sync_in_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sync_in_s1_agent_rsp_fifo (
		.clk               (clk_CPU_clk_clk),                             //       clk.clk
		.reset             (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (sync_in_s1_agent_rf_source_data),             //        in.data
		.in_valid          (sync_in_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (sync_in_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (sync_in_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (sync_in_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (sync_in_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (sync_in_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (sync_in_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (sync_in_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (sync_in_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) spi_adda_spi_control_port_agent (
		.clk                     (clk_CPU_clk_clk),                                            //             clk.clk
		.reset                   (jtag_uart_reset_reset_bridge_in_reset_reset),                //       clk_reset.reset
		.m0_address              (spi_adda_spi_control_port_agent_m0_address),                 //              m0.address
		.m0_burstcount           (spi_adda_spi_control_port_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (spi_adda_spi_control_port_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (spi_adda_spi_control_port_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (spi_adda_spi_control_port_agent_m0_lock),                    //                .lock
		.m0_readdata             (spi_adda_spi_control_port_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (spi_adda_spi_control_port_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (spi_adda_spi_control_port_agent_m0_read),                    //                .read
		.m0_waitrequest          (spi_adda_spi_control_port_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (spi_adda_spi_control_port_agent_m0_writedata),               //                .writedata
		.m0_write                (spi_adda_spi_control_port_agent_m0_write),                   //                .write
		.rp_endofpacket          (spi_adda_spi_control_port_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (spi_adda_spi_control_port_agent_rp_ready),                   //                .ready
		.rp_valid                (spi_adda_spi_control_port_agent_rp_valid),                   //                .valid
		.rp_data                 (spi_adda_spi_control_port_agent_rp_data),                    //                .data
		.rp_startofpacket        (spi_adda_spi_control_port_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (spi_adda_spi_control_port_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (spi_adda_spi_control_port_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (spi_adda_spi_control_port_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (spi_adda_spi_control_port_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (spi_adda_spi_control_port_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (spi_adda_spi_control_port_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (spi_adda_spi_control_port_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (spi_adda_spi_control_port_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (spi_adda_spi_control_port_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (spi_adda_spi_control_port_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_012_out_0_ready),                          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_012_out_0_valid),                          //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_012_out_0_data),                           //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_012_out_0_error),                          //                .error
		.rdata_fifo_src_ready    (spi_adda_spi_control_port_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (spi_adda_spi_control_port_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (spi_adda_spi_control_port_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                      //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                        //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) spi_adda_spi_control_port_agent_rsp_fifo (
		.clk               (clk_CPU_clk_clk),                                            //       clk.clk
		.reset             (jtag_uart_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		.in_data           (spi_adda_spi_control_port_agent_rf_source_data),             //        in.data
		.in_valid          (spi_adda_spi_control_port_agent_rf_source_valid),            //          .valid
		.in_ready          (spi_adda_spi_control_port_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (spi_adda_spi_control_port_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (spi_adda_spi_control_port_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (spi_adda_spi_control_port_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (spi_adda_spi_control_port_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (spi_adda_spi_control_port_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (spi_adda_spi_control_port_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (spi_adda_spi_control_port_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                      // (terminated)
		.csr_read          (1'b0),                                                       // (terminated)
		.csr_write         (1'b0),                                                       // (terminated)
		.csr_readdata      (),                                                           // (terminated)
	...
	CPU_mm_interconnect_0_router_002 router_011 (
		.sink_ready         (sync_in_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (sync_in_s1_agent_rp_valid),                   //          .valid
		.sink_data          (sync_in_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (sync_in_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (sync_in_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (clk_CPU_clk_clk),                             //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_mm_interconnect_0_router_002 router_014 (
		.sink_ready         (spi_adda_spi_control_port_agent_rp_ready),         //      sink.ready
		.sink_valid         (spi_adda_spi_control_port_agent_rp_valid),         //          .valid
		.sink_data          (spi_adda_spi_control_port_agent_rp_data),          //          .data
		.sink_startofpacket (spi_adda_spi_control_port_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (spi_adda_spi_control_port_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_CPU_clk_clk),                                  //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	CPU_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_CPU_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sync_in_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (sync_in_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (sync_in_s1_agent_rdata_fifo_src_ready),       //         .ready
	...
	CPU_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_CPU_clk_clk),                                      // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_reset_reset_bridge_in_reset_reset),          // in_rst_0.reset
		.in_0_data      (spi_adda_spi_control_port_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (spi_adda_spi_control_port_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (spi_adda_spi_control_port_agent_rdata_fifo_src_ready), //         .ready
