	component CPU is
		port (
			...
			spi_adda_MISO            : in    std_logic                     := 'X';             -- MISO
			spi_adda_MOSI            : out   std_logic;                                        -- MOSI
			spi_adda_SCLK            : out   std_logic;                                        -- SCLK
			spi_adda_SS_n            : out   std_logic_vector(1 downto 0);                     -- SS_n
	...
	u0 : component CPU
		port map (
			...
			spi_adda_MISO            => CONNECTED_TO_spi_adda_MISO,            -- spi_adda.MISO
			spi_adda_MOSI            => CONNECTED_TO_spi_adda_MOSI,            --         .MOSI
			spi_adda_SCLK            => CONNECTED_TO_spi_adda_SCLK,            --         .SCLK
			spi_adda_SS_n            => CONNECTED_TO_spi_adda_SS_n,            --         .SS_n
