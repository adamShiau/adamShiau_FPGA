...
(
    ...
    localparam PAD10 = log2ceil(64'h20022b0 - 64'h20022a0); 
    localparam PAD11 = log2ceil(64'h20022c0 - 64'h20022b0); 
    localparam PAD12 = log2ceil(64'h20022c8 - 64'h20022c0); 
    localparam PAD13 = log2ceil(64'h20022d0 - 64'h20022c8); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h20022d0;
    ...
    // ( 0x20022a0 .. 0x20022b0 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 26'h20022a0   ) begin
            src_channel = 14'b00001000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x20022b0 .. 0x20022c0 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 26'h20022b0   ) begin
            src_channel = 14'b00000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 11;
    end

    // ( 0x20022c0 .. 0x20022c8 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 26'h20022c0  && read_transaction  ) begin
            src_channel = 14'b00000000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x20022c8 .. 0x20022d0 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 26'h20022c8   ) begin
