	component CPU is
		port (
			...
			mux_in_export            : out   std_logic_vector(1 downto 0);                     -- export
			...
			spi_adc_SS_n             : out   std_logic_vector(1 downto 0);                     -- SS_n
			spi_dac_MISO             : in    std_logic                     := 'X';             -- MISO
			spi_dac_MOSI             : out   std_logic;                                        -- MOSI
			spi_dac_SCLK             : out   std_logic;                                        -- SCLK
			spi_dac_SS_n             : out   std_logic_vector(1 downto 0);                     -- SS_n
			trigger_in_export        : in    std_logic                     := 'X';             -- export
			...
			wdt_export               : out   std_logic_vector(1 downto 0)                      -- export
		);
	end component CPU;
	...
	u0 : component CPU
		port map (
			...
			mux_in_export            => CONNECTED_TO_mux_in_export,            --     mux_in.export
			...
			trigger_in_export        => CONNECTED_TO_trigger_in_export,        -- trigger_in.export
			...
			wdt_export               => CONNECTED_TO_wdt_export                --        wdt.export
		);
