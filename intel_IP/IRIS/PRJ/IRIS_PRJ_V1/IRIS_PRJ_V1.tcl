...
set top_file_name "IRIS_TOP_V1.sv"
...
set hw_ip_accl "../../HW_IP/ACCL" 

# FOG IP 子目錄 (IRIS/HW_IP/FOG)
...
set_global_assignment -name SEARCH_PATH "${hw_ip_accl}"
