...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../HINS_PRJ_V1.jdi
...
# The SOPC System ID 
# setting SOPC_SYSID is 16777216
SOPC_SYSID_FLAG += --id=16777216
ELF_PATCH_FLAG  += --id 16777216

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x20022a0
SOPC_SYSID_FLAG += --sidp=0x20022a0
ELF_PATCH_FLAG  += --sidp 0x20022a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1765464871
SOPC_SYSID_FLAG += --timestamp=1765464871
ELF_PATCH_FLAG  += --timestamp 1765464871
...
# setting hal.stdout is uart_dbg
ELF_PATCH_FLAG  += --stdout_dev uart_dbg
