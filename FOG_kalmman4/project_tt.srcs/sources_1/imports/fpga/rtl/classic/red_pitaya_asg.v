...
module red_pitaya_asg (
  ...
  , output reg [31:0] test_reg1
  , output reg [31:0] test_reg2
);
...
localparam RSZ = 15 ;  // RAM size 2^RSZ
...
if (dac_rstn_i == 1'b0) begin
   ...
   if (sys_wen) begin
      ...
      if (sys_addr[19:0]==20'h2120) test_reg1 <= sys_wdata[31:0];
      if (sys_addr[19:0]==20'h2220) test_reg2 <= sys_wdata[31:0];
   end
...
if (dac_rstn_i == 1'b0) begin
   ...
   casez (sys_addr[19:0])
     ...
     20'h02120: begin sys_ack <= sys_en;  sys_rdata <= {test_reg1      }; end
     20'h02220: begin sys_ack <= sys_en;  sys_rdata <= {test_reg2      }; end
