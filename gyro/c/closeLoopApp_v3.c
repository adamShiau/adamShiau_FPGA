...
#define ADDR_OUT_V2PIN		XPAR_MYAXI_2017P4_50REG_S00_AXI_BASEADDR + 13*4
#define ADDR_OUT_TRIGDLY	XPAR_MYAXI_2017P4_50REG_S00_AXI_BASEADDR + 14*4
...
#define ADDR_IN_STEP_SM		XPAR_MYAXI_2017P4_50REG_S00_AXI_BASEADDR + 30*4
...
//							else closeLoop_flag = 1;
				...
				case 11: {
							Xil_Out32(ADDR_OUT_V2PIN, value);
							break;}
				...
				case 13: {
							Xil_Out32(ADDR_OUT_TRIGDLY, value);
							break;
				}
...
//			else err = Xil_In32(ADDR_IN_ERR);
			step = Xil_In32(ADDR_IN_STEP);
			err = Xil_In32(ADDR_IN_ERR);
			step_SM = Xil_In32(ADDR_IN_STEP_SM);
			...
			Xil_Out32(UARTLITE_TX,step >> 24);
			Xil_Out32(UARTLITE_TX,step >> 16);
			Xil_Out32(UARTLITE_TX,step >> 8);
			Xil_Out32(UARTLITE_TX,step >> 0);

			Xil_Out32(UARTLITE_TX,step_SM >> 0);
